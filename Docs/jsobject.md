...
`JSObject` is the base class for all 450+ typed JavaScript wrappers in SpawnDev.BlazorJS. It wraps an `IJSInProcessObjectReference` and provides strongly typed access to JavaScript object properties, methods, and events.

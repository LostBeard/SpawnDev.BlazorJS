...
namespace SpawnDev.BlazorJS
{
    ...
    public class AsyncFuncCallback<T1, T2, T3, T4, T5, TResult> : Callback
    {
        ...
        /// </summary>
        /// <param name="callback">.Net target method</param>
        public static implicit operator AsyncFuncCallback<T1, T2, T3, T4, T5, TResult>?(Func<T1, T2, T3, T4, T5, Task<TResult>>? callback) => callback == null ? null : new AsyncFuncCallback<T1, T2, T3, T4, T5, TResult>(callback);
    ...
    public class AsyncFuncCallback<T1, T2, T3, T4, T5, T6, TResult> : Callback
    {
        ...
        /// </summary>
        /// <param name="callback">.Net target method</param>
        public static implicit operator AsyncFuncCallback<T1, T2, T3, T4, T5, T6, TResult>?(Func<T1, T2, T3, T4, T5, T6, Task<TResult>>? callback) => callback == null ? null : new AsyncFuncCallback<T1, T2, T3, T4, T5, T6, TResult>(callback);
    ...
    public class AsyncFuncCallback<T1, T2, T3, T4, T5, T6, T7, TResult> : Callback
    {
        ...
        /// </summary>
        /// <param name="callback">.Net target method</param>
        public static implicit operator AsyncFuncCallback<T1, T2, T3, T4, T5, T6, T7, TResult>?(Func<T1, T2, T3, T4, T5, T6, T7, Task<TResult>>? callback) => callback == null ? null : new AsyncFuncCallback<T1, T2, T3, T4, T5, T6, T7, TResult>(callback);

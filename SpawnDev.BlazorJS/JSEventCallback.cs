...
namespace SpawnDev.BlazorJS
{
    ...
    /// }
    /// </summary>
    public class JSEventCallback<T1, T2, T3, T4, T5> : JSEventCallbackBase
    {
        #region 0 Arguments
        static Dictionary<Action, JEventCallbackInfo> attachedEvents0 = new Dictionary<Action, JEventCallbackInfo>();
        /// <summary>
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5> operator +(JSEventCallback<T1, T2, T3, T4, T5> a, Action b)
        {
            if (!attachedEvents0.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo(b, new ActionCallback(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5> operator +(JSEventCallback<T1, T2, T3, T4, T5> a, Action<T1> b)
        {
            if (!attachedEvents1.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1>(b, new ActionCallback<T1>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5> operator +(JSEventCallback<T1, T2, T3, T4, T5> a, Action<T1, T2> b)
        {
            if (!attachedEvents2.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2>(b, new ActionCallback<T1, T2>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5> operator +(JSEventCallback<T1, T2, T3, T4, T5> a, Action<T1, T2, T3> b)
        {
            if (!attachedEvents3.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3>(b, new ActionCallback<T1, T2, T3>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5> operator +(JSEventCallback<T1, T2, T3, T4, T5> a, Action<T1, T2, T3, T4> b)
        {
            if (!attachedEvents4.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4>(b, new ActionCallback<T1, T2, T3, T4>(b));
        ...
        #endregion
        #region 5 Arguments
        static Dictionary<Action<T1, T2, T3, T4, T5>, JEventCallbackInfo<T1, T2, T3, T4, T5>> attachedEvents5 = new Dictionary<Action<T1, T2, T3, T4, T5>, JEventCallbackInfo<T1, T2, T3, T4, T5>>();
        /// <summary>
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5> operator +(JSEventCallback<T1, T2, T3, T4, T5> a, Action<T1, T2, T3, T4, T5> b)
        {
            if (!attachedEvents5.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4, T5>(b, new ActionCallback<T1, T2, T3, T4, T5>(b));
                attachedEvents5[b] = info;
            }
            info.RefCount += 1;
            a.On(info.Callback);
            return a;
        ...
        public static JSEventCallback<T1, T2, T3, T4, T5> operator -(JSEventCallback<T1, T2, T3, T4, T5> a, Action<T1, T2, T3, T4, T5> b)
        {
            if (!attachedEvents5.TryGetValue(b, out var info)) return a;
            a.Off?.Invoke(info.Callback);
            info.RefCount -= 1;
            if (info.RefCount <= 0)
            {
                info.Callback.Dispose();
                attachedEvents5.Remove(b);
            }
            return a;
        }
        #endregion
    ...
    /// }
    /// </summary>
    public class JSEventCallback<T1, T2, T3, T4, T5, T6> : JSEventCallbackBase
    {
        #region 0 Arguments
        static Dictionary<Action, JEventCallbackInfo> attachedEvents0 = new Dictionary<Action, JEventCallbackInfo>();
        /// <summary>
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action b)
        {
            if (!attachedEvents0.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo(b, new ActionCallback(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action<T1> b)
        {
            if (!attachedEvents1.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1>(b, new ActionCallback<T1>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action<T1, T2> b)
        {
            if (!attachedEvents2.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2>(b, new ActionCallback<T1, T2>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action<T1, T2, T3> b)
        {
            if (!attachedEvents3.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3>(b, new ActionCallback<T1, T2, T3>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action<T1, T2, T3, T4> b)
        {
            if (!attachedEvents4.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4>(b, new ActionCallback<T1, T2, T3, T4>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action<T1, T2, T3, T4, T5> b)
        {
            if (!attachedEvents5.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4, T5>(b, new ActionCallback<T1, T2, T3, T4, T5>(b));
        ...
        #endregion
        #region 6 Arguments
        static Dictionary<Action<T1, T2, T3, T4, T5, T6>, JEventCallbackInfo<T1, T2, T3, T4, T5, T6>> attachedEvents6 = new Dictionary<Action<T1, T2, T3, T4, T5, T6>, JEventCallbackInfo<T1, T2, T3, T4, T5, T6>>();
        /// <summary>
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action<T1, T2, T3, T4, T5, T6> b)
        {
            if (!attachedEvents6.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4, T5, T6>(b, new ActionCallback<T1, T2, T3, T4, T5, T6>(b));
                attachedEvents6[b] = info;
            }
            info.RefCount += 1;
            a.On(info.Callback);
            return a;
        ...
        public static JSEventCallback<T1, T2, T3, T4, T5, T6> operator -(JSEventCallback<T1, T2, T3, T4, T5, T6> a, Action<T1, T2, T3, T4, T5, T6> b)
        {
            if (!attachedEvents6.TryGetValue(b, out var info)) return a;
            a.Off?.Invoke(info.Callback);
            info.RefCount -= 1;
            if (info.RefCount <= 0)
            {
                info.Callback.Dispose();
                attachedEvents6.Remove(b);
            }
            return a;
        }
        #endregion
    ...
    /// }
    /// </summary>
    public class JSEventCallback<T1, T2, T3, T4, T5, T6, T7> : JSEventCallbackBase
    {
        #region 0 Arguments
        static Dictionary<Action, JEventCallbackInfo> attachedEvents0 = new Dictionary<Action, JEventCallbackInfo>();
        /// <summary>
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action b)
        {
            if (!attachedEvents0.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo(b, new ActionCallback(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1> b)
        {
            if (!attachedEvents1.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1>(b, new ActionCallback<T1>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1, T2> b)
        {
            if (!attachedEvents2.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2>(b, new ActionCallback<T1, T2>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1, T2, T3> b)
        {
            if (!attachedEvents3.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3>(b, new ActionCallback<T1, T2, T3>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1, T2, T3, T4> b)
        {
            if (!attachedEvents4.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4>(b, new ActionCallback<T1, T2, T3, T4>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1, T2, T3, T4, T5> b)
        {
            if (!attachedEvents5.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4, T5>(b, new ActionCallback<T1, T2, T3, T4, T5>(b));
        ...
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1, T2, T3, T4, T5, T6> b)
        {
            if (!attachedEvents6.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4, T5, T6>(b, new ActionCallback<T1, T2, T3, T4, T5, T6>(b));
        ...
        #endregion
        #region 7 Arguments
        static Dictionary<Action<T1, T2, T3, T4, T5, T6, T7>, JEventCallbackInfo<T1, T2, T3, T4, T5, T6, T7>> attachedEvents7 = new Dictionary<Action<T1, T2, T3, T4, T5, T6, T7>, JEventCallbackInfo<T1, T2, T3, T4, T5, T6, T7>>();
        /// <summary>
        /// Attaches an event handler
        /// </summary>
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator +(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1, T2, T3, T4, T5, T6, T7> b)
        {
            if (!attachedEvents7.TryGetValue(b, out var info))
            {
                info = new JEventCallbackInfo<T1, T2, T3, T4, T5, T6, T7>(b, new ActionCallback<T1, T2, T3, T4, T5, T6, T7>(b));
                attachedEvents7[b] = info;
            }
            info.RefCount += 1;
            a.On(info.Callback);
            return a;
        ...
        public static JSEventCallback<T1, T2, T3, T4, T5, T6, T7> operator -(JSEventCallback<T1, T2, T3, T4, T5, T6, T7> a, Action<T1, T2, T3, T4, T5, T6, T7> b)
        {
            if (!attachedEvents7.TryGetValue(b, out var info)) return a;
            a.Off?.Invoke(info.Callback);
            info.RefCount -= 1;
            if (info.RefCount <= 0)
            {
                info.Callback.Dispose();
                attachedEvents7.Remove(b);
            }
            return a;
        }
        #endregion

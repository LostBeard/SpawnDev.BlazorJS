...
namespace SpawnDev.BlazorJS.JSObjects
{
    ...
    public class IDBOpenDBRequest : IDBRequest<IDBDatabase>
    {
        ...
        /// </summary>
        public JSEventCallback<IDBVersionChangeEvent> OnBlocked { get => new JSEventCallback<IDBVersionChangeEvent>(o => AddEventListener("blocked", o), o => RemoveEventListener("blocked", o)); set { } }
        /// <summary>

...
namespace SpawnDev.BlazorJS.JSObjects
{
    ...
    public class TransformerAsync
    {
        ...
        public FuncCallback<TransformStreamDefaultController, Task>? Start { get; set; }
        /// <summary>
        ...
        /// </summary>
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public FuncCallback<JSObject, TransformStreamDefaultController, Task>? Transform { get; set; }
        /// <summary>
        ...
        /// </summary>
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public FuncCallback<TransformStreamDefaultController, Task>? Flush { get; set; }
    }
}

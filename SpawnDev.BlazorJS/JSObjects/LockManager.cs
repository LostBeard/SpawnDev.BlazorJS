...
namespace SpawnDev.BlazorJS.JSObjects {
    ...
    public class LockManager : JSObject {
        ...
        public Task RequestAsync(string lockName, FuncCallback<Lock, Promise> callback) => JSRef.CallVoidAsync("request", lockName, callback);
        public Task RequestAsync(string lockName, object options, FuncCallback<Lock, Promise> callback) => JSRef.CallVoidAsync("request", lockName, options, callback);

...
{
    //public class IceCandidateSimple
    //{
    //    //public static implicit operator RTCIceCandidate(IceCandidateSimple candidate)
    //    //{
    //    //    var ret = new RTCIceCandidate { Candidate = candidate.Sdp, SdpMLineIndex = candidate.SdpMLineIndex, SdpMid = candidate.SdpMid };
    //    //    return ret;
    //    //}

    //    //public static implicit operator IceCandidateSimple(RTCIceCandidate candidate)
    //    //{
    //    //    return new IceCandidateSimple { Sdp = candidate.Candidate, SdpMLineIndex = candidate.SdpMLineIndex, SdpMid = candidate.SdpMid };
    //    //}
    //    //public static explicit operator RTCIceCandidate(IceCandidateSimple candidate)
    //    //{
    //    //    var ret = new RTCIceCandidate { Candidate = candidate.Sdp, SdpMLineIndex = candidate.SdpMLineIndex, SdpMid = candidate.SdpMid };
    //    //    return ret;
    //    //}

    //    public static explicit operator IceCandidateSimple(RTCIceCandidate candidate)
    //    {
    //        return new IceCandidateSimple { Sdp = candidate.Candidate, SdpMLineIndex = candidate.SdpMLineIndex, SdpMid = candidate.SdpMid };
    //    }
    ...
    //    public IceCandidateSimple() { }
    //    public IceCandidateSimple(string sdpMid, int? sdpMLineIndex, string sdp, string serverUrl = "")
    //    {
    //        Sdp = sdp;
    //        ServerUrl = serverUrl;
    //        SdpMid = sdpMid;
    ...
    {        
        public static explicit operator RTCIceCandidate(RTCIceCandidateInfo candidate)
        {
            var ret = new RTCIceCandidate(candidate);
            return ret;
        }

        public static explicit operator RTCIceCandidateInfo(RTCIceCandidate candidate)
        {
            return new RTCIceCandidateInfo { Candidate = candidate.Candidate, SdpMLineIndex = candidate.SdpMLineIndex, SdpMid = candidate.SdpMid };
        }
